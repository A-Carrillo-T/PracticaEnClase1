...
const sequelize = new Sequelize(dbConfig.DATABASE_URL, {
  ...
  // Configuración específica de PostgreSQL para SSL (Requerido por Neon)
  dialectOptions: {
    ssl: {
      require: true,             // La conexión debe usar SSL obligatoriamente
      rejectUnauthorized: false  // Acepta el certificado de Neon sin estrictas verificaciones CA
    }
  },
